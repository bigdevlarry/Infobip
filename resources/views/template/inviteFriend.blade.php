    ...
    <head>
        ...
        <style type="text/css">
            ...
            .email-content-cta-button{
                ...
                border-bottom: 8px solid #1E5083;
                border-left: 18px solid #1E5083;
                border-right: 18px solid #1E5083;
                border-top: 8px solid #1E5083;
                font-weight: normal;
            }
            .mcnPreviewText{
        ...
        */
            body,#bodyTable{
                /*@editable*/background-color:#f4f7fb;
            }
        /*
        @tab Page
        @sections Background Style
                                        ...
                                        <tbody class="mcnTextBlockOuter">
                                            <tr>
                                                <td class="mcnTextBlockInner" valign="top">
                                                    <div style="border-top: solid 3px #296DB3; border-radius: 3px 3px 0 0;margin-top:40px;">
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
                                            ...
                                            <tr>
                                                <td class="mcnTextBlockInner" valign="top">
                                                    <div class="mcnTextContent" style="
                                                        ...
                                                        background-image: url('https://mcusercontent.com/a6e67a18e55d79c5772d95952/images/d9eb62b7-3f7b-4d50-a0a0-b686419da18b.png');
